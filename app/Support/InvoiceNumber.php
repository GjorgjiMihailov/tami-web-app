 ...
 * осум фајла, со два различни разделника — на PDF-от коса црта, кон УЈП
 * цртичка. Ниту едно вакво лепење повеќе не постои. Секое ново место што
 * прикажува број мора да поминува оттука.
 */
class InvoiceNumber
{
