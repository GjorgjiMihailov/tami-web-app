<div>
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('sales-invoices.create', $company) }}" class="bg-brand text-white px-3 py-1.5 rounded-md text-sm">New invoice</a>
    </div>
        ...
        <tbody class="divide-y divide-gray-100">
            @forelse ($invoices as $invoice)
                <tr class="text-sm">
                    ...
                    <td class="py-2 px-4">
                        <a href="{{ route('sales-invoices.show', [$company, $invoice]) }}" class="text-brand hover:underline">View</a>
                    </td>
                </tr>
            @empty
