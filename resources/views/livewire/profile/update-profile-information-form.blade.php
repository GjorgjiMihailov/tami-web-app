...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Ажурирајте ги информациите за профилот и е-поштата на вашата сметка.
        </p>
    </header>
                ...
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button wire:click.prevent="sendVerification" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand">
                            Кликнете тука за повторно да испратите линк за потврда.
                        </button>
                    </p>

                    @if (session('status') === 'verification-link-sent')
                        <p class="mt-2 font-medium text-sm text-green-600">
                            Нов линк за потврда е испратен на вашата е-пошта.
                        </p>
                    @endif
                </div>
            @endif
