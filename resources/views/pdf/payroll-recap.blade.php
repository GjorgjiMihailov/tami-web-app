...
<body>
    ...
    @if ($run->journalEntry)
        ...
        <p class="muted">Книжен е само делот на товар на работодавачот, па збировите не се еднакви со горната табела. Разликата ја прават две работи: делот на товар на ФЗО, кој се пресметува и се пријавува но не е трошок на фирмата, и доплатата до најниска основица, која е трошок на фирмата над бруто-то и стои во посебен ред погоре.</p>
    @elseif ($run->isDraft())
