...
class PurchaseInvoiceServiceTest extends TestCase
{
    ...
    public function test_confirming_two_invoices_for_the_same_company_reuses_the_same_system_group(): void
    {
        ...
        $first->lines()->create(['account_id' => $expenseAccount->id, 'description' => 'A', 'quantity' => '1', 'unit_price' => '100.00', 'vat_rate' => '18.00']);
        $second = PurchaseInvoice::factory()->for($company)->create(['partner_id' => $partner->id, 'invoice_date' => '2026-03-02']);
        $second->lines()->create(['account_id' => $expenseAccount->id, 'description' => 'B', 'quantity' => '1', 'unit_price' => '100.00', 'vat_rate' => '18.00']);
