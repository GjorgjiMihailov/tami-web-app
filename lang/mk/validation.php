...
return [
    ...
    'attributes' => [
        ...
        'firstName' => 'име',
        'lastName' => 'презиме',
        'municipalityCode' => 'општина',
        'bankAccount' => 'трансакциска сметка',
        'insuranceTypeCode' => 'вид на стаж',
        'registrationNumber' => 'број на пријава',
        'employedOn' => 'вработен од',
        'terminatedOn' => 'престанок',
        ...
        'ratePension' => 'ПИО %',
        'rateHealth' => 'здравствено %',
        'rateInjury' => 'повреда %',
        'rateUnemployment' => 'невработеност %',
        'rateTax' => 'ПДД %',
        'personalAllowance' => 'лично ослободување',
        'averageSalary' => 'просечна плата',
